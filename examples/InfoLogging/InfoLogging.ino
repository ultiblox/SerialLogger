...
void setup() {
    ...
    // This debug line will be hidden unless debugging enabled
    Logger.debugln("[DEBUG] System initialized and running");
...
void loop() {
    // These debug lines will be hidden unless debugging enabled
